...
class DOCXtoDOTXConverterUI:
    def __init__(self, master):
        self.master = master
        self.master.title("DOCX to DOTX")
        ...
        # Create widgets
        self.heading_label = tk.Label(self.master, text="DOCX to DOTX", font=("Helvetica", 16, "bold"))
    ...
    def convert_files(self):
        ...
        for selected_file in self.selected_files:
            try:
                ...
                doc.save(os.path.join(self.output_directory, dotx_output_name))
