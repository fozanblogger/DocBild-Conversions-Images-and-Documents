...
class DOCXtoDOCConverterUI:
    def __init__(self, master):
        self.master = master
        self.master.title("DOCX to DOC")  # Updated title
        ...
        # Create widgets
        self.heading_label = tk.Label(self.master, text="DOCX to DOC", font=("Helvetica", 16, "bold"))  # Updated label
    ...
    def perform_conversion(self):
        for selected_file in self.selected_files:
            try:
                ...
                doc_output_name = f"{docx_name}.doc"
                ...
                if os.path.exists(output_file):
                    ...
                    count = 1
                    while True:
                        new_name = f"{docx_name} ({count}).doc"
                ...
                docx.save(os.path.join(self.output_directory, doc_output_name))

                # Display success message
                success_message = f"Conversion successful: {docx_basename} converted to {doc_output_name}."
