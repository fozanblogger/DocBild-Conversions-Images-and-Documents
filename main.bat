...
echo 3. PDF Conversion Options
echo 4. DOCX Conversion Options
echo 0. Exit
echo.
...
) else if %jpg_choice%==7 (
    python img\jpgtojp2.py
) else if %jpg_choice%==8 (
...
if %pdf_choice%==1 (
    ...
    python pdf\pdftoppng.py
) else if %pdf_choice%==5 (
    python pdf\pdftoxrtf.py
