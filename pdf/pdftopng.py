...
class PDFtoPNGConverterUI:
    def __init__(self, master):
        ...
        # Create widgets
        self.heading_label = tk.Label(self.master, text="PDF to PNG", font=("Helvetica", 16, "bold"))
        ...
        try:
            ...
            for i, pdf_file in enumerate(self.selected_files):
                ...
                for page_number in range(len(pdf_document)):
                    ...
                    output_filename = os.path.join(self.output_directory, f"{os.path.basename(pdf_file)}_{page_number + 1}.png")
