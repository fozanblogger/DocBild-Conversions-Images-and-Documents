...
class DocbildUI:
    ...
    def create_pdf_conversion_section(self):
        ...
        self.heading_label_pdf.grid(row=6, column=0, columnspan=4, pady=10, sticky="w")  # Add padding around the label
        ...
        buttons = [
            ...
            ("PDF to DOCX", self.convert_pdf_to_docx, 8, 0),
        ]
    ...
    def create_docx_conversion_section(self):
        ...
        self.heading_label_docx.grid(row=10, column=0, columnspan=4, pady=10, sticky="w")  # Add padding around the label

        # Buttons for DOCX to other formats conversions
        buttons = [
            ("DOCX to DOC", self.convert_docx_to_doc, 11, 0),
            ("DOCX to DOT", self.convert_docx_to_dot, 11, 1),
            ("DOCX to DOTX", self.convert_docx_to_dotx, 11, 2),
            ("DOCX to PDF", self.convert_docx_to_pdf, 11, 3),
        ]
        self.create_buttons(buttons, row=11)
