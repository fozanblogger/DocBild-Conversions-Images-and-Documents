...
class DocbildUI:
    def __init__(self, master):
        ...
        self.heading_label_png.grid(row=0, column=0, columnspan=6, pady=10)
        ...
        self.btn_png_to_ps.grid(row=1, column=5, padx=5, pady=5)

        self.btn_png_to_psd = ttk.Button(self.master, text="PNG to PSD", command=self.convert_png_to_psd, width=20)
        self.btn_png_to_psd.grid(row=2, column=0, padx=5, pady=5)

        self.btn_png_to_webp = ttk.Button(self.master, text="PNG to WEBP", command=self.convert_png_to_webp, width=20)
        self.btn_png_to_webp.grid(row=2, column=1, padx=5, pady=5)

        self.btn_png_to_tiff = ttk.Button(self.master, text="PNG to TIFF", command=self.convert_png_to_tiff, width=20)
        self.btn_png_to_tiff.grid(row=2, column=2, padx=5, pady=5)

        self.btn_png_to_avif = ttk.Button(self.master, text="PNG to AVIF", command=self.convert_png_to_avif, width=20)
        self.btn_png_to_avif.grid(row=2, column=3, padx=5, pady=5)

        self.btn_png_to_heif = ttk.Button(self.master, text="PNG to HEIF", command=self.convert_png_to_heif, width=20)
        self.btn_png_to_heif.grid(row=2, column=4, padx=5, pady=5)
        ...
        self.heading_label_jpg.grid(row=3, column=0, columnspan=6, pady=10)
        ...
        self.btn_jpg_to_ps.grid(row=4, column=5, padx=5, pady=5)

        self.btn_jpg_to_psd = ttk.Button(self.master, text="JPG to PSD", command=self.convert_jpg_to_psd, width=20)
        self.btn_jpg_to_psd.grid(row=5, column=0, padx=5, pady=5)

        self.btn_jpg_to_webp = ttk.Button(self.master, text="JPG to WEBP", command=self.convert_jpg_to_webp, width=20)
        self.btn_jpg_to_webp.grid(row=5, column=1, padx=5, pady=5)

        self.btn_jpg_to_tiff = ttk.Button(self.master, text="JPG to TIFF", command=self.convert_jpg_to_tiff, width=20)
        self.btn_jpg_to_tiff.grid(row=5, column=2, padx=5, pady=5)

        self.btn_jpg_to_avif = ttk.Button(self.master, text="JPG to AVIF", command=self.convert_jpg_to_avif, width=20)
        self.btn_jpg_to_avif.grid(row=5, column=3, padx=5, pady=5)

        self.btn_jpg_to_heif = ttk.Button(self.master, text="JPG to HEIF", command=self.convert_jpg_to_heif, width=20)
        self.btn_jpg_to_heif.grid(row=5, column=4, padx=5, pady=5)
    ...
    def convert_png_to_tiff(self):
        img_script_path = os.path.join("img", "pngtotiff.py")
        subprocess.run(["python", img_script_path])
    ...
    def convert_jpg_to_tiff(self):
        img_script_path = os.path.join("img", "jpgtotiff.py")
        subprocess.run(["python", img_script_path])
