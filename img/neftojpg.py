...
class ImageConverterUI:
    def __init__(self, master):
        ...
        self.heading_label = tk.Label(self.master, text="NEF to JPG", font=("Helvetica", 16, "bold"))
        self.heading_label.pack(pady=10)

        self.btn_choose_file = ttk.Button(self.master, text="Choose NEF Files", command=self.choose_files)
    ...
    def choose_files(self):
        self.selected_files = filedialog.askopenfilenames(filetypes=[("NEF files", "*.nef")])
    ...
    def convert_images(self):
        ...
        for i, file_path in enumerate(self.selected_files):
            try:
                ...
                image.convert("RGB").save(new_file_path, format="JPEG")
                success_count += 1
