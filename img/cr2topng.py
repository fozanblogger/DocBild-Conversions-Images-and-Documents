...
class ImageConverterUI:
    def __init__(self, master):
        ...
        self.heading_label = tk.Label(self.master, text="CR2 to PNG", font=("Helvetica", 16, "bold"))
        self.heading_label.pack(pady=10)

        self.btn_choose_file = ttk.Button(self.master, text="Choose CR2 Files", command=self.choose_files)
    ...
    def choose_files(self):
        self.selected_files = filedialog.askopenfilenames(filetypes=[("CR2 files", "*.cr2")])
