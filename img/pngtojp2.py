...
class ImageConverterUI:
    def __init__(self, master):
        ...
        self.heading_label = tk.Label(self.master, text="PNG to JP2", font=("Helvetica", 16, "bold"))
        self.heading_label.pack(pady=10)

        self.btn_choose_file = ttk.Button(self.master, text="Choose PNG Files", command=self.choose_files)
    ...
    def choose_files(self):
        self.selected_files = filedialog.askopenfilenames(filetypes=[("PNG files", "*.png")])
    ...
    def convert_images(self):
        ...
        for i, file_path in enumerate(self.selected_files):
            try:
                ...
                new_file_path = os.path.join(self.output_directory, os.path.splitext(os.path.basename(file_path))[0] + ".jp2")
                image.save(new_file_path, format="JPEG2000")
                success_count += 1
