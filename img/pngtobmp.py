...
class ImageConverterUI:
    def __init__(self, master):
        ...
        self.heading_label = tk.Label(self.master, text="PNG to BMP", font=("Helvetica", 16, "bold"))
    ...
    def convert_images(self):
        ...
        for i, file_path in enumerate(self.selected_files):
            try:
                ...
                new_file_path = os.path.join(self.output_directory, os.path.splitext(os.path.basename(file_path))[0] + ".bmp")
